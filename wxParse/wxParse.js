...
function wxParse() {
    ...
    for (var s in o.view = {}, void (o.view.imagePadding = 0) !== r && (o.view.imagePadding = r), 
    o.nodes) "div" == o.nodes[s].tag && (o.nodes[s].styleStr = o.nodes[s].styleStr + ";height:auto;");
    var l = {};
...
function calMoreImageInfo(e, t, a, i) {
    ...
    if (n && 0 != n.images.length) {
        var o = n.images, d = wxAutoImageCal(e.detail.width, e.detail.height, a, i), s = o[t].index, l = "" + i, h = !0, m = !1, g = void 0;
        try {
            for (var w, u = s.split(".")[Symbol.iterator](); !(h = (w = u.next()).done); h = !0) {
                l += ".nodes[" + w.value + "]";
            }
        } catch (e) {
            m = !0, g = e;
